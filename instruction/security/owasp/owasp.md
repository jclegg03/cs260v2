...
```masteryls
{"id":"", "title":"Identifying Access Control Types", "type":"multiple-choice"}
...
```masteryls
{"id":"sec-misconfig-01", "title":"Identifying Security Misconfiguration", "type":"multiple-choice"}
...
```masteryls
{"id":"ssc-001", "title":"Identifying Supply Chain Risks", "type":"multiple-choice"}
...
```masteryls
{"id":"crypto-failures-01", "title":"Identifying Cryptographic Failures", "type":"multiple-choice"}
...
```masteryls
{"id":"injection-prevention-01", "title":"Identifying Injection Prevention", "type":"multiple-choice"}
...
3. The browser calculates the 20% discount and sends the *final price* to the server's `/checkout` endpoint.
...
```masteryls
{"id":"insecure-design-01", "title":"Understanding Insecure Design", "type":"multiple-choice"}
